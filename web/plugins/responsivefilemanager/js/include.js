...
!function (e, a, t) {
    ...
    function i() {
        e("#textfile_create_area").parent().parent().remove(), e.ajax({
            type: "GET",
            ...
            bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {
                ...
                "class": "btn-inverse",
                callback: function () {
                    var a = e("#create_text_file_name").val() + e("#create_text_file_extension").val(), t = e("#textfile_create_area").val();
                    if (null !== a) {
                        a = w(a);
                        ...
                        e.ajax({
                            ...
                            data: {path: n, name: a, new_content: t}
                        }).done(function (a) {
    ...
    function r(a) {
        ...
        e.ajax({
            ...
            bootbox.dialog(n, [{label: e("#cancel").val(), "class": "btn"}, {
                label: e("#ok").val(),
                "class": "btn-inverse",
                callback: function () {
            ...
            bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {
                ...
                callback: function () {
                    ...
                    e.ajax({
                        ...
                        "" != t ? bootbox.alert(t) : setTimeout(function () {
                                window.location.href = e("#refresh").attr("href").replace(/lang=[\w]*&/i, "lang=" + a + "&") + "&" + (new Date).getTime()
                            }, 100)
                    })
                }
    ...
    function o(a) {
        ...
        var t = a.find(".rename-file-paths"), n = t.attr("data-path"), i = t.attr("data-permissions"), r = t.attr("data-folder");
        e.ajax({
            type: "POST",
            url: "ajax_calls.php?action=chmod",
            data: {path: n, permissions: i, folder: r}
        }).done(function (a) {
            bootbox.dialog(a, [{label: e("#cancel").val(), "class": "btn"}, {
                label: e("#ok").val(),
                "class": "btn-inverse",
                callback: function () {
                    var a = "-";
                    a += e("#u_4").is(":checked") ? "r" : "-", a += e("#u_2").is(":checked") ? "w" : "-", a += e("#u_1").is(":checked") ? "x" : "-", a += e("#g_4").is(":checked") ? "r" : "-", a += e("#g_2").is(":checked") ? "w" : "-", a += e("#g_1").is(":checked") ? "x" : "-", a += e("#a_4").is(":checked") ? "r" : "-", a += e("#a_2").is(":checked") ? "w" : "-", a += e("#a_1").is(":checked") ? "x" : "-";
                    var i = e("#chmod_form #chmod_value").val();
                    if ("" != i && "undefined" != typeof i) {
                        var l = e("#chmod_form input[name=apply_recursive]:checked").val();
                        ("" == l || "undefined" == typeof l) && (l = "none"), e.ajax({
                            type: "POST",
                            url: "execute.php?action=chmod",
                            data: {path: n, new_mode: i, is_recursive: l, folder: r}
                        }).done(function (e) {
                            "" != e ? bootbox.alert(e) : t.attr("data-permissions", a)
                        })
                    }
                }
            }], {header: e("#lang_file_permission").val()}), setTimeout(function () {
                c(!1)
            }, 100)
        })
    }
    ...
    function p(a, t) {
        if ("copy" == t || "cut" == t) {
            var n;
            n = a.find(".rename-file-paths").attr(a.hasClass("directory") ? "data-path" : "data-path"), e.ajax({
                type: "POST",
                url: "ajax_calls.php?action=copy_cut",
                data: {path: n, sub_action: t}
            }).done(function (a) {
    ...
    function f(a) {
        bootbox.confirm(e("#lang_paste_confirm").val(), e("#cancel").val(), e("#ok").val(), function (t) {
            if (1 == t) {
                var n;
                n = "undefined" != typeof a ? a.find(".rename-folder").attr("data-path") : e("#sub_folder").val() + e("#fldr_value").val(), e.ajax({
                    type: "POST",
    ...
    function u(a, t) {
        ...
        a.parent().hide(100), e.ajax({
            type: "POST",
            url: "ajax_calls.php?action=copy_cut",
            data: {path: i, sub_action: "cut"}
        }).done(function (n) {
            if ("" != n) bootbox.alert(n); else {
                var i;
                i = "undefined" != typeof t ? t.hasClass("back-directory") ? t.find(".path").val() : t.find(".rename-folder").attr("data-path") : e("#sub_folder").val() + e("#fldr_value").val(), e.ajax({
                    type: "POST",
                    url: "execute.php?action=paste_clipboard",
                    data: {path: i}
                }).done(function (t) {
    ...
    function m(t) {
        ...
        if (e(".uploader").css("width", n), i.val() > 0) {
            if (1 == i.val()) e("ul.grid li, ul.grid figure").css("width", "100%"); else {
                var l = Math.floor(n / 380);
                0 == l && (l = 1, e("h4").css("font-size", 12)), n = Math.floor(n / l - 3), e("ul.grid li, ul.grid figure").css("width", n)
            }
            r.hide()
        } else a.touch && r.show()
    }
    ...
    function w(a) {
        return null != a ? ("true" == e("#transliteration").val() && (a = b(a), a = a.replace(/[^A-Za-z0-9\.\-\[\] _]+/g, "")), "true" == e("#convert_spaces").val() && (a = a.replace(/ /g, e("#replace_with").val())), "true" == e("#lower_case").val() && (a = a.toLowerCase()), a = a.replace('"', ""), a = a.replace("'", ""), a = a.replace("/", ""), a = a.replace("\\", ""), a = a.replace(/<\/?[^>]+(>|$)/g, ""), e.trim(a)) : null
    }

    function y(a, t, n, i, r) {
        null !== n && (n = w(n), e.ajax({
            type: "POST",
            url: "execute.php?action=" + a,
            data: {path: t, name: n.replace("/", "")}
        }).done(function (e) {
    ...
    function x(a, t) {
        var n = e("li.dir", "ul.grid").filter(":visible"), i = e("li.file", "ul.grid").filter(":visible"), r = [], l = [], o = [], c = [];
        n.each(function () {
            ...
            var a = e(this), n = a.find(t).val();
            if (e.isNumeric(n))for (n = parseFloat(n); "undefined" != typeof o[n] && o[n];)n = parseFloat(parseFloat(n) + parseFloat(.001)); else n = n + "a" + a.find("h4 a").attr("data-file");
            o[n] = a.html(), c.push(n)
        }), e.isNumeric(l[0]) ? l.sort(function (e, a) {
                return parseFloat(e) - parseFloat(a)
            }) : l.sort(), e.isNumeric(c[0]) ? c.sort(function (e, a) {
                return parseFloat(e) - parseFloat(a)
            }) : c.sort(), a && (l.reverse(), c.reverse()), n.each(function (a) {
            var t = e(this);
            t.html(r[l[a]])
        }), i.each(function (a) {
            var t = e(this);
    ...
    var j = "9.11.0", T = !0, I = 0, S = function () {
        var e = 0;
        return function (a, t) {
            clearTimeout(e), e = setTimeout(a, t)
        }
    }(), U = function (a) {
        if (1 == e("#ftp").val())var t = e("#ftp_base_url").val() + e("#upload_dir").val() + e("#fldr_value").val(); else var t = e("#base_url").val() + e("#cur_dir").val();
        var n = a.find("a.link").attr("data-file");
        ...
        contextActions: {
            copy_url: function (a) {
                ...
                show_animation(), e.ajax({
                    ...
                    hide_animation(), "" != a ? bootbox.alert(a) : window.location.href = e("#refresh").attr("href") + "&" + (new Date).getTime()
                })
            }, edit_img: function (a) {
                var t = a.attr("data-name");
                if (1 == e("#ftp").val())var n = e("#ftp_base_url").val() + e("#upload_dir").val() + e("#fldr_value").val() + t; else var n = e("#base_url").val() + e("#cur_dir").val() + t;
                var i = e("#aviary_img");
                ...
                bootbox.prompt(e("#lang_duplicate").val(), e("#cancel").val(), e("#ok").val(), function (e) {
                    if (null !== e && (e = w(e), e != t)) {
                        ...
                        y("duplicate_file", n.attr("data-path"), e, n, "apply_file_duplicate")
                    }
                }, t)
            }, select: function (a) {
                var t, n = U(a), i = e("#field_id").val(), r = e("#return_relative_url").val();
                if (1 == r && (n = n.replace(e("#base_url").val(), ""), n = n.replace(e("#cur_dir").val(), "")), t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)if (1 == e("#crossdomain").val()) t.postMessage({
                    sender: "responsivefilemanager",
                    url: n,
                    field_id: i
                }, "*"); else {
                    var l = e("#" + i, t.document);
                    l.val(n).trigger("change"), "function" == typeof t.responsive_filemanager_callback && t.responsive_filemanager_callback(i), g()
                } else apply_any(n)
            }, copy: function (e) {
                p(e, "copy")
            }, cut: function (e) {
            ...
            e.contextMenu({
                ...
                build: function (n) {
                    ...
                    return (n.find(".img-precontainer-mini .filetype").hasClass("png") || n.find(".img-precontainer-mini .filetype").hasClass("jpg") || n.find(".img-precontainer-mini .filetype").hasClass("jpeg")) && t && (i.items.edit_img = {
                        ...
                        icon: "edit_img",
                        disabled: !1
                    }), n.hasClass("directory") && 0 != e("#type_param").val() && (i.items.select = {
                        ...
                        icon: "dimension",
                        disabled: !0
                    }), ("true" === e("#show_folder_size").val() || "true" === e("#show_folder_size").val()) && (i.items.size = n.hasClass("directory") ? {
                            name: n.find(".file-size").html() + " - " + n.find(".nfiles").val() + " " + e("#lang_files").val() + " - " + n.find(".nfolders").val() + " " + e("#lang_folders").val(),
                            icon: "size",
                            disabled: !0
                        } : {
            ...
            t.on("click", ".modalAV", function (a) {
                ...
                bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function (e) {
                    null !== e && (e = w(e), e != i && y("rename_file", a.attr("data-path"), e, t, "apply_file_rename"))
                }, i)
            }), t.on("click", ".rename-folder", function () {
                var a = e(this), t = a.parent().parent().parent(), n = t.find("h4"), i = e.trim(n.text());
                bootbox.prompt(e("#rename").val(), e("#cancel").val(), e("#ok").val(), function (e) {
                    null !== e && (e = w(e).replace(".", ""), e != i && y("rename_folder", a.attr("data-path"), e, t, "apply_folder_rename"))
                }, i)
            }), t.on("click", ".delete-file", function () {
                var a = e(this);
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (t) {
                    if (1 == t) {
                        y("delete_file", a.attr("data-path"), "", "", "");
                ...
                bootbox.confirm(a.attr("data-confirm"), e("#cancel").val(), e("#ok").val(), function (t) {
                    if (1 == t) {
                        y("delete_folder", a.attr("data-path"), "", "", "");
            ...
            e("#uploadURL").on("click", function (a) {
                a.preventDefault();
                var t = e("#url").val(), n = e("#cur_path").val(), i = e("#cur_dir_thumb").val();
                show_animation(), e.ajax({
                    type: "POST",
                    url: "upload.php",
                    data: {path: n, path_thumb: i, url: t}
                }).done(function (a) {
                    "" != a && alert("Файл загружен"), hide_animation(), e("#url").val("")
                }).fail(function (a) {
                    alert(e("#lang_error_upload").val()), hide_animation(), e("#url").val("")
                })
            })
        }, makeSort: function (a) {
            e("input[name=radio-sort]").on("click", function () {
                var n = e(this).attr("data-item"), i = e("#" + n), r = e(".filters label");
                r.removeClass("btn-inverse"), r.find("i").removeClass("icon-white"), e("#filter-input").val(""), i.addClass("btn-inverse"), i.find("i").addClass("icon-white"), "ff-item-type-all" == n ? (a ? e(".grid li").show(300) : window.location.href = e("#current_url").val() + "&sort_by=" + e("#sort_by").val() + "&descending=" + (t ? 1 : 0), "undefined" != typeof Storage && localStorage.setItem("sort", "")) : e(this).is(":checked") && (e(".grid li").not("." + n).hide(300), e(".grid li." + n).show(300), "undefined" != typeof Storage && localStorage.setItem("sort", n)), C()
            });
    ...
    e(document).ready(function () {
        if (e("#rfmDropzone").on("click", ".dz-success .dz-detail", function () {
            ...
            }), T && R.makeContextMenu(), "undefined" != typeof Storage) {
            var t = localStorage.getItem("sort");
            if (t) {
                var r = e("#" + t);
                r.addClass("btn-inverse"), r.find("i").addClass("icon-white"), e(".grid li").not("." + t).hide(300), e(".grid li." + t).show(300)
            }
        }
        if (e("#full-img").on("click", function () {
                e("#previewLightbox").lightbox("hide")
            }), e("body").on("click", function () {
                e(".tip-right").tooltip("hide")
            }), R.bindGridEvents(), parseInt(e("#file_number").val()) > parseInt(e("#file_number_limit_js").val()))var o = !1; else var o = !0;
        if (R.makeSort(o), R.makeFilters(o), R.uploadURL(), e("#info").on("click", function () {
                ...
                l()
            }), R.makeUploader(), e("body").on("keypress", function (e) {
        ...
        e(window).resize(function () {
            m(28)
        }), m(14), v(1 == e("#clipboard").val() ? !0 : !1), e("li.dir, li.file").draggable({
            distance: 20,
            cursor: "move",
            helper: function () {
            ...
            start: function (a, t) {
                e(t.helper).addClass("ui-draggable-helper"), 0 == e("#view").val() && e("#main-item-container").addClass("no-effect-slide")
            },
            stop: function () {
        ...
        var i = e("#cur_dir").val(), r = e("#subdir").val(), l = e("#base_url").val(), o = a.substr(0, a.lastIndexOf(".")), c = a.split(".").pop();
        c = c.toLowerCase();
        var s = "", d = ["ogg", "mp3", "wav"], p = ["mp4", "ogg", "webm"];
        if (1 == e("#ftp").val())var f = encodeURL(e("#ftp_base_url").val() + e("#upload_dir").val() + e("#fldr_value").val() + a); else var u = e("#return_relative_url").val(), f = encodeURL((1 == u ? r : l + i) + a);
        if ("" != t)if (1 == e("#crossdomain").val()) n.postMessage({
            ...
            v.val(f).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
        } else e.inArray(c, ext_img) > -1 ? (f = f + "?" + (new Date).getTime(), s = '<img src="' + f + '" alt="' + o + '" />') : e.inArray(c, p) > -1 ? s = '<video controls source src="' + f + '" type="video/' + c + '">' + o + "</video>" : e.inArray(c, d) > -1 ? ("mp3" == c && (c = "mpeg"), s = '<audio controls src="' + f + '" type="audio/' + c + '">' + o + "</audio>") : s = '<a href="' + f + '" title="' + o + '">' + o + "</a>", 1 == e("#crossdomain").val() ? n.postMessage({
                sender: "responsivefilemanager",
                url: f,
                field_id: null,
                html: s
        ...
        var r = e("#subdir").val();
        r = r.replace("\\", "/");
        var l = e("#base_url").val();
        if (1 == e("#ftp").val())var o = encodeURL(e("#ftp_base_url").val() + e("#upload_dir").val() + e("#fldr_value").val() + a); else var c = e("#return_relative_url").val(), o = encodeURL((1 == c ? r : l + i) + a);
        if ("" != t)if (1 == e("#crossdomain").val()) n.postMessage({
            sender: "responsivefilemanager",
            url: o,
            field_id: t
            ...
            s.val(o).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
        } else apply_any(o)
        ...
        if ("" != t)if (1 == e("#crossdomain").val()) n.postMessage({
            ...
            var s = e("#" + t, n.document);
            s.val(o).trigger("change"), "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
        } else e("#add_time_to_img").val() && (o = o + "?" + (new Date).getTime()), apply_any(o)
        ...
        var n;
        a.attr("data-name", t), a.parent().attr("data-name", t), a.find("h4").text(t);
        var i = a.find("a.link");
        n = i.attr("data-file");
        var r = n.substring(n.lastIndexOf("/") + 1), l = n.substring(n.lastIndexOf(".") + 1);
        i.each(function () {
            e(this).attr("data-file", encodeURIComponent(t + "." + l))
        }), a.find("img").each(function () {
            var a = e(this).attr("src");
            e(this).attr("src", a.replace(r, t + "." + l) + "?time=" + (new Date).getTime()), e(this).attr("alt", t + " thumbnails")
        });
        var o = a.find("a.preview");
        n = o.attr("data-url"), "undefined" != typeof n && n && o.attr("data-url", n.replace(encodeURIComponent(r), encodeURIComponent(t + "." + l))), a.parent().attr("data-name", t + "." + l), a.attr("data-name", t + "." + l), a.find(".name_download").val(t + "." + l);
        var c = a.find("a.rename-file"), s = a.find("a.delete-file"), d = c.attr("data-path"), p = d.replace(r, t + "." + l);
        ...
        a.find("h4 > a").text(t);
        var i = a.find(".folder-link"), r = i.attr("href"), l = e("#fldr_value").val(), o = r.replace("fldr=" + l + encodeURIComponent(n), "fldr=" + l + encodeURIComponent(t));
        i.each(function () {
            e(this).attr("href", o)
        });
